...
import com.rickshawpuller.r.driverapp.helper.DirectionJSONParser;
import com.rickshawpuller.r.driverapp.interfaces.IFCMService;
import com.rickshawpuller.r.driverapp.interfaces.googleAPIInterface;
import com.rickshawpuller.r.driverapp.interfaces.locationListener;
import com.rickshawpuller.r.driverapp.model.fcm.FCMResponse;
import com.rickshawpuller.r.driverapp.model.firebase.History;
import com.rickshawpuller.r.driverapp.model.fcm.Notification;
import com.rickshawpuller.r.driverapp.model.fcm.Sender;
import com.rickshawpuller.r.driverapp.model.firebase.User;
import com.rickshawpuller.r.driverapp.R;
import com.rickshawpuller.r.driverapp.retrofit.FCMClient;
import com.rickshawpuller.r.driverapp.retrofit.RetrofitClient;
import com.rickshawpuller.r.driverapp.util.LocationUtil;
...
public class TrackingActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(this, R.raw.rickshaw_style_map));
