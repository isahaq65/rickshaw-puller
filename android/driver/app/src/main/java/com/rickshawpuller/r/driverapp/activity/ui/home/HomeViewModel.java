...
import com.rickshawpuller.r.driverapp.activity.ui.home.HomeFragmentListener.ShowMessageListener;
    ...
    public void initializeLocation(Activity activity) {
        location = new LocationUtil(activity, new locationListener() {
            ...
            public void locationResponse(LocationResult response) {
                ...
                //Toast.makeText(activity.getApplicationContext(), Common.currentLat.toString(),Toast.LENGTH_SHORT).show();
                Log.println(1,Common.currentLat.toString(), Common.currentLng.toString());
