...
import com.rickshawpuller.r.driverapp.activity.viewmodel.HomeViewModel;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void showDialogUpdateCarType() {
        ...
        final RadioButton rickshawG =carType.findViewById(R.id.rickshawGeneral);
        final RadioButton rickshawB =carType.findViewById(R.id.rickshawBattery);

        if(Common.currentUser.getCarType().equals("General rickshaw"))
            rickshawG.setChecked(true);
        else if(Common.currentUser.getCarType().equals("Battery rickshaw"))
            rickshawB.setChecked(true);
        ...
        alertDialog.setPositiveButton("UPDATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(rickshawG.isChecked())
                    updateInfo.put("carType", rickshawG.getText().toString());
                else if(rickshawB.isChecked())
                    updateInfo.put("carType", rickshawB.getText().toString());
